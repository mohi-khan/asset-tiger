...
const HomeNavbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const benefitsPosition = document.getElementById("benefits")?.offsetTop || 0
      const pricingPosition = document.getElementById("pricing")?.offsetTop || 0
      ...
      if (currentPosition < reviewsPosition) {
        setActive("#")
      } else if (currentPosition < featuresPosition) {
        setActive("#reviews")
      } else if (currentPosition < appsPosition) {
        setActive("#features")
      } else if (currentPosition < benefitsPosition) {
        setActive("#apps")
      } else if (currentPosition < pricingPosition) {
        setActive("#benefits")
  ...
  return (
    <div className={isScrolled ? "bg-white shadow fixed w-full z-10 py-2" : "bg-white fixed w-full z-10 py-4"}>
      <div className="flex items-center justify-between w-full">
        ...
        <div className="hidden lg:flex items-center space-x-4">
          <a
            ...
            className="border border-gray-800 text-gray-800 px-4 py-2 rounded hover:bg-gray-100 transition-colors cursor-pointer"
          >
            CREATE NEW ACCOUNT
          </a>
          <a
            ...
            className="bg-yellow-500 text-white px-6 py-2 rounded hover:bg-yellow-600 transition-colors cursor-pointer"
          >
            SIGN IN
          </a>
        </div>
